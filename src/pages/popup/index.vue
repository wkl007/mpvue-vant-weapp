<template>
  <div class="container">
    ...
    <demo-block title="弹出位置" padding>
      ...
      <van-button @click="toggleTopPopup" custom-class="demo-margin-right">顶部弹出</van-button>
      <van-popup
        :show="show.top"
        position="top"
        :overlay="false"
      ...
      >
        <van-button @click="toggleRightPopup" custom-class="demo-margin-right">关闭弹层</van-button>
